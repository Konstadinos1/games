...
const CONFIG = {
  ...
  CHICKEN_TYPES: {
    COMMON: {
      id: 'COMMON', name: 'Common', coins: 1, score: 100,
      glowColor: 'rgba(255,255,255,0.3)', weight: 60, size: 38, xpBonus: 5,
      hue: null
    },
    RARE: {
      id: 'RARE', name: 'Rare Gold', coins: 5, score: 500,
      glowColor: 'rgba(255,215,0,0.6)', weight: 25, size: 44, xpBonus: 15,
      hue: 50
    },
    EPIC: {
      id: 'EPIC', name: 'Piri Epic', coins: 10, score: 1000,
      glowColor: 'rgba(255,80,20,0.7)', weight: 12, size: 50, xpBonus: 30,
      hue: 20
    },
    LEGENDARY: {
      id: 'LEGENDARY', name: 'Smoked Legend', coins: 25, score: 2500,
